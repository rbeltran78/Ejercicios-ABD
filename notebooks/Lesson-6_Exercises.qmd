...
Fíjate que @ross2022 asume una distribución discreta (y no uniforme) para el parámetro de probabilidad **en los ejemplos 7.1 a 7.3**.
Es decir, **no se trata de un modelo beta-binomial**.
(En el ejemplo 7.4 usa una distribución discreta uniforme, luego tampoco exactamente un modelo beta-binomial).
